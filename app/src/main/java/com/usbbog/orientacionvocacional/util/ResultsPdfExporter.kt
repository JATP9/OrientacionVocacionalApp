...
import com.usbbog.orientacionvocacional.platform.ReportExportResult
 ...
 */
class AndroidResultsReportExporter(
    private val context: Context,
) : ResultsReportExporter {
    private companion object {
        const val PAGE_WIDTH = 595
        const val PAGE_HEIGHT = 842
        const val MARGIN = 48f
        const val HEADER_HEIGHT = 96f
        const val TABLE_TOP_MARGIN = 40f
        const val TABLE_BOTTOM = PAGE_HEIGHT - 40f
        const val CELL_PADDING = 6f

        val BrandColor = Color.rgb(239, 125, 0)
        val DarkColor = Color.rgb(50, 50, 50)
        val GrayColor = Color.rgb(109, 109, 109)
        val FooterLineColor = Color.rgb(233, 228, 219)
        val TableLineColor = Color.rgb(200, 200, 200)
    }
    ...
    override fun createAndShare(
        ...
        return ReportExportResult(file.name)
    }
